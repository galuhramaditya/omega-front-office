...
<div id="report">
    ...
    <!-- END PAGE TITLE-->
    @include("pages.outlet-revenue-analysis.filter")
    <!-- LOADER -->
    @include("includes.loader")
    <!-- END LOADER -->
    <div id="on-print">
        @include("pages.outlet-revenue-analysis.chart")
        @include("pages.outlet-revenue-analysis.table")
    </div>
</div>
<!-- END CONTENT BODY -->
@endsection
...
<script src="{{ url('/assets/scripts/pages/outlet-revenue-analysis.js') }}" type="text/javascript"></script>
@endsection