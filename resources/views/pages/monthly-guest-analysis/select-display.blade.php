<div class="row display-hide" id="select-display">
    <div class="col-xs-6 text-center">
        <div class="btn-group">
            <button class="btn red" v-on:click.prevent="report.handle_display({based_on : 'player_status', by : 'player'})"><i class="fa fa-user-o"></i> Number by Player Status</button>
    ...
    <div class="col-xs-6 text-center">
        <div class="btn-group">
            <button class="btn grey-mint" v-on:click.prevent="report.handle_display({based_on : 'gender', by : 'player'})"><i class="fa fa-venus-mars"></i> Number by Gender</button>
